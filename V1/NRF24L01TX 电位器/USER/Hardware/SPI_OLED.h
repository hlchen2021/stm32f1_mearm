...
void OLED12864_Format4(unsigned char x,unsigned char y,bit Rev,float);//1.22V
void OLED12864_Format5(unsigned char x,unsigned char y,bit Rev,unsigned int temp);//0xff
